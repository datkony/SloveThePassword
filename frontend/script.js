...
async function freeNumber() {
    try {
        const response = await fetch('http://my-backend-api.onrender.com/removeAllAvailableNumbers', {
            method: 'POST',
        });
...
async function addAvailableNumbers() {
    try {
        ...
        const response = await fetch('http://my-backend-api.onrender.com/pushAvailableNumbers', {
            method: 'POST',
            headers: {
...
async function compareExpression() {
    try {
        ...
        const response = await fetch('http://my-backend-api.onrender.com/compareExpressions', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function checkProperties() {
    try {
        ...
        const response = await fetch('http://my-backend-api.onrender.com/checkProperties', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function matchCode() {
    try {
        ...
        const response = await fetch('http://my-backend-api.onrender.com/matchCode', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function submitTheAnswer() {
    ...
    if (!(answer >= 0 && answer <= 9999)) {
        ...
        try {
            const response = await fetch('http://my-backend-api.onrender.com/check', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
async function popupResult(isWon) {
    ...
    try {
        const response = await fetch('http://my-backend-api.onrender.com/secret');
        const data = await response.json();
...
async function generateNewSecretCode() {
    const response = await fetch('http://my-backend-api.onrender.com/generate', {
        method: 'POST',
    });
